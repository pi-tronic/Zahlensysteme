...
AEntry = ttk.Combobox(window, width=19, values=values)
AEntry.grid(column=0, row=1, padx=10, pady=0, sticky=tk.W)

BEntry = ttk.Combobox(window, width=19, values=values)
BEntry.grid(column=1, row=1, padx=10, pady=0, sticky=tk.W)

IEntry = ttk.Entry(window, style="BW.TEntry")
IEntry.grid(column=0, row=3, padx=10, pady=0, sticky=tk.W)
